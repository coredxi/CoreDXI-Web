...
- **Phase 1.5 영업 지원 트랙(2026-08-22 신설, ~10/31)**: 2026-08-18 합류한 영업이사의 아웃바운드(카톡·메일로 소개서 1장 + `/ax-check?ref=` 링크)를 지원. 타깃은 IT·통신·AV 시스템 구축 업체 대표·영업 담당자, 중점 솔루션은 "중소기업 AI 도입·AX 전환 컨설팅" 단일 오퍼. 1단계(~09/05) `/ax-check` 8문항 깔때기 + 규칙 기반 즉시 요약 + `/admin/leads`, **2단계(09/08~09/26, 2026-09-02 재편) 자동 팔로업 — T0 즉시 요약 메일 + T1 D+2 영업일 상세 진단 자동 발송(Vercel Cron)·관리자 보류 창·영업이사는 HOT 통화만** + 솔루션 단일 오퍼 재편(LLM 상세본은 그 위의 후속 개선), 3단계(~10/31) 팔로업 뉴스레터 발송(8/8 범위 제외 결정 철회)·미팅 예약. 설계 `docs/superpowers/specs/2026-08-22-sales-funnel-ax-check-design.md`·`…/2026-09-02-ax-check-auto-followup-design.md`, 실행 `docs/superpowers/plans/2026-08-22-sales-enablement-action-plan.md`·`…/2026-09-02-sales-channel-auto-followup-action-plan.md`, 진행 현황은 Notion AI 비서 집무실
